...
┌─────────────────────────┐
│   PRIORIDAD_IA          │ ◄──── INTELIGENCIA ARTIFICIAL
├─────────────────────────┤       (Módulo de Decisión)
│ - id_prioridad          │
│ - nivel (P1/P2/P3/P4)   │
│ - score_confianza       │
...
**El módulo de Inteligencia Artificial interviene en:**

- Análisis de la descripción del incidente mediante NLP
- Generación de embeddings semánticos para búsqueda de similitud
- Clasificación automática de categoría y prioridad
- Predicción del nivel de urgencia basada en patrones históricos
- Justificación de decisiones para mayor transparencia
